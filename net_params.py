...
class AutoTomo(nn.Module):
    """
    We apply both linear and non-linear units in the deep neural network to approximate the complicated mapping from
    the lower-dimensional vector of link loads to the higher-dimensional vector of OD flows.
    """
...
class RBM:
    ...
    def train(self, dataset):
        ...
        for epoch in learning:
            ...
            if train_loss.item() / counter > self.previous_loss_before_stagnation and epoch > \
