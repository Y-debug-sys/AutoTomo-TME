...
def load_data(root_dir, tm_fn, rm_fn, n_train, n_test, known_rate, b_size, scale=10**9, model_name='autotomo'):
    ...
    test_flow = traffic[0:test_size]

    train_link = link_loads[0:train_size]
    test_link = link_loads[0:test_size]
